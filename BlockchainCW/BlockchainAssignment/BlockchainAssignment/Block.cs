...
namespace BlockchainAssignment
{
    class Block
    {
        ...
        private int index, // Position of the block in the sequence
            difficulty = 4; //  number of 0's to proceed hash value

        public String prevHash, // pointer to the previous block

            hash, // The current blocks hash
            merkleRoot,  // The merkle root of all transactions in the block
            minerAddress; // Public Key of the Miner
        ...
        // Rewards
        public double reward; // Simple fixed reward 
        ...
        public Block(Block lastBlock, List<Transaction> transactions, String minerAddress)
        {
            ...
            this.minerAddress = minerAddress; // wallet to be credited 
            reward = 1.0; // Assign fixed value of 1
